...
const QuestionnairesTopicContent = () => {
  ...
  const [size, setSize] = useState(
    Cookies.get("pagination-size-questionnaire-topics")
      ? JSON.parse(Cookies.get("pagination-size-questionnaire-topics"))
      : 20
  );
  ...
  }, [dispatch, page, topicsRender, size, query, typeSelect]);
  const updateSize = (newSize) => {
    setSize(newSize); // Update state
    Cookies.set(
      "pagination-size-questionnaire-topics",
