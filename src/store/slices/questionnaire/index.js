...
export const getContractTopics = createAsyncThunk(
  "/getContractTopics",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.getContractTopics(
        data.size,
        data.page,
        data.query,
        data.visibility
...
export const getContractTopicsAll = createAsyncThunk(
  "/getContractTopicsAll",
  async (visibility, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.getContractTopicsAll(visibility);
      dispatch(setLoading(false));
      return response?.data;
    } catch (error) {
      errorMessage(error.response?.data?.message);
...
export const addContractTopics = createAsyncThunk(
  "/addContractTopics",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.addContractTopics(data);
      dispatch(setLoading(false));
      dispatch(setContractTopicsRender((prev) => !prev));
      dispatch(setViewModalVisible(true));
    } catch (error) {
      errorMessage(error.response?.data?.message);
      dispatch(setLoading(false));
...
export const editContractTopics = createAsyncThunk(
  "/editContractTopics",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.editContractTopics(data);
      dispatch(setLoading(false));
      dispatch(setContractTopicsRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const deleteContractTopics = createAsyncThunk(
  "/deleteContractTopics",
  async (id, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.deleteContractTopics(id);
      dispatch(setLoading(false));
      dispatch(setDeleteModalVisible(false));
      dispatch(setContractTopicsRender((prev) => !prev));
    } catch (error) {
...
export const contractTopicsVisibility = createAsyncThunk(
  "contractTopicsVisibility",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.contractTopicsVisibility(data);
      dispatch(setLoading(false));
      dispatch(setContractTopicsRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const getContractTypesSubtypes = createAsyncThunk(
  "/getContractTypesSubtypes",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.getContractTypesSubtypes(
        data.size,
        data.page,
        data.query,
        data.visibility,
...
export const addContractTypesSubtypes = createAsyncThunk(
  "/addContractTypesSubtypes",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.addContractTypesSubtypes(data);
      dispatch(setLoading(false));
      dispatch(setContractTypesSubtypesRender((prev) => !prev));
      dispatch(setViewModalVisible(true));
    } catch (error) {
      errorMessage(error.response?.data?.message);
      dispatch(setLoading(false));
...
export const editContractTypesSubtypes = createAsyncThunk(
  "/editContractTypesSubtypes",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.editContractTypesSubtypes(data);
      dispatch(setLoading(false));
      dispatch(setContractTypesSubtypesRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const deleteContractTypesSubtypes = createAsyncThunk(
  "/deleteContractTypesSubtypes",
  async (id, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.deleteContractTypesSubtypes(id);
      dispatch(setLoading(false));
      dispatch(setDeleteModalVisible(false));
      dispatch(setContractTypesSubtypesRender((prev) => !prev));
    } catch (error) {
...
export const contractTypesSubtypesVisibility = createAsyncThunk(
  "contractTypesSubtypesVisibility",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.contractTypesSubtypesVisibility(data);
      dispatch(setLoading(false));
      dispatch(setContractTypesSubtypesRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const getDefaultAgreementPlans = createAsyncThunk(
  "/getDefaultAgreementPlans",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.getDefaultAgreementPlans(
        data.size,
        data.page,
        data.query,
        data.visibility
...
export const addDefaultAgreementPlans = createAsyncThunk(
  "/addDefaultAgreementPlans",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.addDefaultAgreementPlans(data);
      dispatch(setLoading(false));
      dispatch(setDefaultAgreementPlansRender((prev) => !prev));
      dispatch(setViewModalVisible(true));
    } catch (error) {
      errorMessage(error.response?.data?.message);
      dispatch(setLoading(false));
...
export const editDefaultAgreementPlans = createAsyncThunk(
  "/editDefaultAgreementPlans",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.editDefaultAgreementPlans(data);
      dispatch(setLoading(false));
      dispatch(setDefaultAgreementPlansRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const deleteDefaultAgreementPlans = createAsyncThunk(
  "/deleteDefaultAgreementPlans",
  async (id, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.deleteDefaultAgreementPlans(id);
      dispatch(setLoading(false));
      dispatch(setDeleteModalVisible(false));
      dispatch(setDefaultAgreementPlansRender((prev) => !prev));
    } catch (error) {
...
export const defaultAgreementPlansVisibility = createAsyncThunk(
  "defaultAgreementPlansVisibility",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.defaultAgreementPlansVisibility(data);
      dispatch(setLoading(false));
      dispatch(setDefaultAgreementPlansRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const getRouteLocations = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.getRouteLocations(
        data.size,
        data.page,
        data.query,
        data.visibility
...
export const getRouteLocationsAll = createAsyncThunk(
  "/getRouteLocationsAll",
  async (visibility, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.getRouteLocationsAll(visibility);
      dispatch(setLoading(false));
      return response?.data;
    } catch (error) {
      errorMessage(error.response?.data?.message);
...
export const addRouteLocations = createAsyncThunk(
  "/addRouteLocations",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.addRouteLocations(data);
      dispatch(setLoading(false));
      dispatch(setRouteLocationsRender((prev) => !prev));
      dispatch(setViewModalVisible(true));
    } catch (error) {
      errorMessage(error.response?.data?.message);
      dispatch(setLoading(false));
...
export const editRouteLocations = createAsyncThunk(
  "/editRouteLocations",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.editRouteLocations(data);
      dispatch(setLoading(false));
      dispatch(setRouteLocationsRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const deleteRouteLocations = createAsyncThunk(
  "/deleteRouteLocations",
  async (id, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.deleteRouteLocations(id);
      dispatch(setLoading(false));
      dispatch(setDeleteModalVisible(false));
      dispatch(setRouteLocationsRender((prev) => !prev));
    } catch (error) {
...
export const routeLocationsVisibility = createAsyncThunk(
  "routeLocationsVisibility",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.routeLocationsVisibility(data);
      dispatch(setLoading(false));
      dispatch(setRouteLocationsRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const getInternalStructure = createAsyncThunk(
  "/getInternalStructure",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.getInternalStructure(
        data.size,
        data.page,
        data.query,
        data.visibility
...
export const getInternalStructureAll = createAsyncThunk(
  "/getInternalStructureAll",
  async (visibility, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.getInternalStructureAll(visibility);
      dispatch(setLoading(false));
      return response?.data;
    } catch (error) {
      errorMessage(error.response?.data?.message);
...
export const addInternalStructure = createAsyncThunk(
  "/addInternalStructure",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.addInternalStructure(data);
      dispatch(setLoading(false));
      dispatch(setInternalStructureRender((prev) => !prev));
      dispatch(setViewModalVisible(true));
    } catch (error) {
      errorMessage(error.response?.data?.message);
      dispatch(setLoading(false));
...
export const editInternalStructure = createAsyncThunk(
  "/editInternalStructure",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.editInternalStructure(data);
      dispatch(setLoading(false));
      dispatch(setInternalStructureRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const deleteInternalStructure = createAsyncThunk(
  "/deleteInternalStructure",
  async (id, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.deleteInternalStructure(id);
      dispatch(setLoading(false));
      dispatch(setDeleteModalVisible(false));
      dispatch(setInternalStructureRender((prev) => !prev));
    } catch (error) {
...
export const internalStructureVisibility = createAsyncThunk(
  "internalStructureVisibility",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.internalStructureVisibility(data);
      dispatch(setLoading(false));
      dispatch(setInternalStructureRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const getBudgetComponents = createAsyncThunk(
  "/getBudgetComponents",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.getBudgetComponents(
        data.size,
        data.page,
        data.query,
        data.visibility
...
export const getBudgetComponentsAll = createAsyncThunk(
  "/getBudgetComponentsAll",
  async (visibility, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.getBudgetComponentsAll(visibility);
      dispatch(setLoading(false));
      return response?.data;
    } catch (error) {
      errorMessage(error.response?.data?.message);
...
export const addBudgetComponents = createAsyncThunk(
  "/addBudgetComponents",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.addBudgetComponents(data);
      dispatch(setLoading(false));
      dispatch(setBudgetComponentsRender((prev) => !prev));
      dispatch(setViewModalVisible(true));
    } catch (error) {
      errorMessage(error.response?.data?.message);
      dispatch(setLoading(false));
...
export const editBudgetComponents = createAsyncThunk(
  "/editBudgetComponents",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.editBudgetComponents(data);
      dispatch(setLoading(false));
      dispatch(setBudgetComponentsRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const deleteBudgetComponents = createAsyncThunk(
  "/deleteBudgetComponents",
  async (id, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.deleteBudgetComponents(id);
      dispatch(setLoading(false));
      dispatch(setDeleteModalVisible(false));
      dispatch(setBudgetComponentsRender((prev) => !prev));
    } catch (error) {
...
export const budgetComponentsVisibility = createAsyncThunk(
  "budgetComponentsVisibility",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.budgetComponentsVisibility(data);
      dispatch(setLoading(false));
      dispatch(setBudgetComponentsRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const getDepartmentsAll = createAsyncThunk(
  ...
  async (visibility, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.getDepartmentsAll(visibility);
      dispatch(setLoading(false));
      return response?.data;
    } catch (error) {
      errorMessage(error.response?.data?.message);
...
export const addDepartments = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.addDepartments(data);
      dispatch(setLoading(false));
      dispatch(setDepartmentsRender((prev) => !prev));
      dispatch(setViewModalVisible(true));
    } catch (error) {
      errorMessage(error.response?.data?.message);
      dispatch(setLoading(false));
...
export const editDepartments = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.editDepartments(data);
      dispatch(setLoading(false));
      dispatch(setDepartmentsRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const deleteDepartments = createAsyncThunk(
  ...
  async (id, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.deleteDepartments(id);
      dispatch(setLoading(false));
      dispatch(setDeleteModalVisible(false));
      dispatch(setDepartmentsRender((prev) => !prev));
    } catch (error) {
...
export const departmentsVisibility = createAsyncThunk(
  "departmentsVisibility",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.departmentsVisibility(data);
      dispatch(setLoading(false));
      dispatch(setDepartmentsRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const getPentions = createAsyncThunk(
  "/getPentions",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.getPentions(
        data.size,
        data.page,
        data.query,
        data.visibility
...
export const getPentionsAll = createAsyncThunk(
  "/getPentionsAll",
  async (visibility, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.getPentionsAll(visibility);
      dispatch(setLoading(false));
      return response?.data;
    } catch (error) {
      errorMessage(error.response?.data?.message);
...
export const addPentions = createAsyncThunk(
  "/addPentions",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.addPentions(data);
      dispatch(setLoading(false));
      dispatch(setPentionsRender((prev) => !prev));
      dispatch(setViewModalVisible(true));
    } catch (error) {
      errorMessage(error.response?.data?.message);
      dispatch(setLoading(false));
...
export const editPentions = createAsyncThunk(
  "/editPentions",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.editPentions(data);
      dispatch(setLoading(false));
      dispatch(setPentionsRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const deletePentions = createAsyncThunk(
  "/deletePentions",
  async (id, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.deletePentions(id);
      dispatch(setLoading(false));
      dispatch(setDeleteModalVisible(false));
      dispatch(setPentionsRender((prev) => !prev));
    } catch (error) {
...
export const pentionsVisibility = createAsyncThunk(
  "pentionsVisibility",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.pentionsVisibility(data);
      dispatch(setLoading(false));
      dispatch(setPentionsRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const getProjectsAll = createAsyncThunk(
  ...
  async (visibility, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.getProjectsAll(visibility);
      dispatch(setLoading(false));
      return response?.data;
    } catch (error) {
      errorMessage(error.response?.data?.message);
...
export const addProjects = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.addProjects(data);
      dispatch(setLoading(false));
      dispatch(setProjectsRender((prev) => !prev));
      dispatch(setViewModalVisible(true));
    } catch (error) {
      errorMessage(error.response?.data?.message);
      dispatch(setLoading(false));
...
export const editProjects = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.editProjects(data);
      dispatch(setLoading(false));
      dispatch(setProjectsRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const projectsVisibility = createAsyncThunk(
  "projectsVisibility",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.projectsVisibility(data);
      dispatch(setLoading(false));
      dispatch(setProjectsRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const getCustomersAll = createAsyncThunk(
  "/getCustomersAll",
  async (visibility, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.getCustomersAll(visibility);
      dispatch(setLoading(false));
      return response?.data;
    } catch (error) {
      errorMessage(error.response?.data?.message);
...
export const addCustomers = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.addCustomers(data);
      dispatch(setLoading(false));
      dispatch(setCustomersRender((prev) => !prev));
      dispatch(setViewModalVisible(true));
    } catch (error) {
      errorMessage(error.response?.data?.message);
      dispatch(setLoading(false));
...
export const editCustomers = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.editCustomers(data);
      dispatch(setLoading(false));
      dispatch(setCustomersRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const deleteCustomers = createAsyncThunk(
  ...
  async (id, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.deleteCustomers(id);
      dispatch(setLoading(false));
      dispatch(setDeleteModalVisible(false));
      dispatch(setCustomersRender((prev) => !prev));
    } catch (error) {
...
export const customersVisibility = createAsyncThunk(
  "customersVisibility",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.customersVisibility(data);
      dispatch(setLoading(false));
      dispatch(setCustomersRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const getinventoryPackageTypes = createAsyncThunk(
  "/getinventoryPackageTypes",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.getinventoryPackageTypes(
        data.size,
        data.page,
        data.query,
        data.visibility
...
export const getinventoryPackageTypesAll = createAsyncThunk(
  "/getinventoryPackageTypesAll",
  async (visibility, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.getinventoryPackageTypesAll(visibility);
      dispatch(setLoading(false));
      return response?.data;
    } catch (error) {
      errorMessage(error.response?.data?.message);
...
export const addinventoryPackageTypes = createAsyncThunk(
  "/addinventoryPackageTypes",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.addinventoryPackageTypes(data);
      dispatch(setLoading(false));
      dispatch(setinventoryPackageTypesRender((prev) => !prev));
      dispatch(setViewModalVisible(true));
    } catch (error) {
      errorMessage(error.response?.data?.message);
      dispatch(setLoading(false));
...
export const editinventoryPackageTypes = createAsyncThunk(
  "/editinventoryPackageTypes",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.editinventoryPackageTypes(data);
      dispatch(setLoading(false));
      dispatch(setinventoryPackageTypesRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const deleteinventoryPackageTypes = createAsyncThunk(
  "/deleteinventoryPackageTypes",
  async (id, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.deleteinventoryPackageTypes(id);
      dispatch(setLoading(false));
      dispatch(setDeleteModalVisible(false));
      dispatch(setinventoryPackageTypesRender((prev) => !prev));
    } catch (error) {
...
export const inventoryPackageTypesVisibility = createAsyncThunk(
  "inventoryPackageTypesVisibility",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.inventoryPackageTypesVisibility(data);
      dispatch(setLoading(false));
      dispatch(setinventoryPackageTypesRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const getAttestations = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.getAttestations(
        data.size,
        data.page,
        data.query,
        data.visibility
...
export const addAttestations = createAsyncThunk(
  "/addAttestations",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.addAttestations(data);
      dispatch(setLoading(false));
      dispatch(setAttestationsRender((prev) => !prev));
      dispatch(setViewModalVisible(true));
    } catch (error) {
      errorMessage(error.response?.data?.message);
      dispatch(setLoading(false));
...
export const editAttestations = createAsyncThunk(
  "/editAttestations",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.editAttestations(data);
      dispatch(setLoading(false));
      dispatch(setAttestationsRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const deleteAttestations = createAsyncThunk(
  "/deleteAttestations",
  async (id, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      await Services.deleteAttestations(id);
      dispatch(setLoading(false));
      dispatch(setDeleteModalVisible(false));
      dispatch(setAttestationsRender((prev) => !prev));
    } catch (error) {
...
export const attestationsVisibility = createAsyncThunk(
  "attestationsVisibility",
  async (data, { dispatch }) => {
    try {
      dispatch(setLoading(true));
      const response = await Services.attestationsVisibility(data);
      dispatch(setLoading(false));
      dispatch(setAttestationsRender((prev) => !prev));
      return response?.data;
    } catch (error) {
...
export const questionnaire = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(getContractTopics.fulfilled, (state, { payload }) => {
      state.contractTopics = payload;
    });
    builder.addCase(getContractTopicsAll.fulfilled, (state, { payload }) => {
      state.contractTopicsAll = payload;
    });
    // ---- end generated reducers ----

    // ---- generated reducers for ContractTypesSubtypes ----
    builder.addCase(getContractTypesSubtypes.fulfilled, (state, { payload }) => {
      state.contractTypesSubtypes = payload;
    });
    builder.addCase(getContractTypesSubtypesAll.fulfilled, (state, { payload }) => {
    ...
    builder.addCase(getDefaultAgreementPlansAll.fulfilled, (state, { payload }) => {
    ...
    builder.addCase(getRouteLocationsAll.fulfilled, (state, { payload }) => {
    ...
    builder.addCase(getBudgetComponentsAll.fulfilled, (state, { payload }) => {
    ...
    builder.addCase(getDepartmentsAll.fulfilled, (state, { payload }) => {
    ...
    builder.addCase(getPentionsAll.fulfilled, (state, { payload }) => {
    ...
    builder.addCase(getProjectsAll.fulfilled, (state, { payload }) => {
    ...
    // ---- generated reducers for Attestations ----
    builder.addCase(getAttestations.fulfilled, (state, { payload }) => {
      state.attestations = payload;
    });
    builder.addCase(getAttestationsAll.fulfilled, (state, { payload }) => {
      state.attestationsAll = payload;
    });
    // ---- end generated reducers ----
    },
});
