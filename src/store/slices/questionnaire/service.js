...
// ---- generated by questionnaireGenerator: InventoryCategories ----
  static getInventoryCategories = async (size, page, query, visibility) => {
    const response = await api.get(`/inventoryCategories/${size}/page/${page}?visibility=${visibility}&name=${query?.name}`);
    return response?.data;
  };
...
// ---- generated by questionnaireGenerator: InventoryModels ----
  static getInventoryModels = async (size, page, query, visibility) => {
    const response = await api.get(`/inventoryModels/${size}/page/${page}?visibility=${visibility}&name=${query?.name}`);
    return response?.data;
  };
