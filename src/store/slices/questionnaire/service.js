...
class Services {
  ...
  static getInventoryBrands = async (size, page, query, visibility) => {
    const response = await api.get(`/inventoryBrands/${size}/page/${page}?visibility=${visibility}&name=${query?.name}`);
    return response?.data;
  };
  static getInventoryBrandsAll = async (visibility) => {
    const response = await api.get(`/inventoryBrands?visibility=${visibility}`);
    return response?.data;
  };
  static addInventoryBrands = async (value) => {
    const response = await api.post("/inventoryBrands", value);
    return response?.data;
  };
  static editInventoryBrands = async (data) => {
    const response = await api.put(`/inventoryBrands/${data?.id}`, data);
    return response?.data;
  };
  static deleteInventoryBrands = async (id) => {
    const response = await api.delete(`/inventoryBrands/${id}`);
    return response?.data;
  };
  static inventoryBrandsVisibility = async (data) => {
    const response = await api.patch(`/inventoryBrands/${data?.id}/visibility/${data?.checked}`);
    return response?.data;
  };
  // ---- end generated ----
  ...
  static getInventoryCategories = async (size, page, visibility) => {
    const response = await api.get(`/inventoryCategories/${size}/page/${page}?visibility=${visibility}`);
    return response?.data;
  };
  static getInventoryCategoriesAll = async (visibility) => {
    const response = await api.get(`/inventoryCategories?visibility=${visibility}`);
    return response?.data;
  };
  static addInventoryCategories = async (value) => {
    const response = await api.post("/inventoryCategories", value);
    return response?.data;
  };
  static editInventoryCategories = async (data) => {
    const response = await api.put(`/inventoryCategories/${data?.id}`, data);
    return response?.data;
  };
  static deleteInventoryCategories = async (id) => {
    const response = await api.delete(`/inventoryCategories/${id}`);
    return response?.data;
  };
  static inventoryCategoriesVisibility = async (data) => {
    const response = await api.patch(`/inventoryCategories/${data?.id}/visibility/${data?.checked}`);
    return response?.data;
  };
  // ---- end generated ----
  ...
  static getinventoryPackageTypes = async (size, page, query, visibility) => {
    const response = await api.get(`/inventoryPackageTypes/${size}/page/${page}?visibility=${visibility}&name=${query?.name}`);
    return response?.data;
  };
  static getinventoryPackageTypesAll = async (visibility) => {
    const response = await api.get(`/inventoryPackageTypes?visibility=${visibility}`);
    return response?.data;
  };
  static addinventoryPackageTypes = async (value) => {
    const response = await api.post("/inventoryPackageTypes", value);
    return response?.data;
  };
  static editinventoryPackageTypes = async (data) => {
    const response = await api.put(`/inventoryPackageTypes/${data?.id}`, data);
    return response?.data;
  };
  static deleteinventoryPackageTypes = async (id) => {
    const response = await api.delete(`/inventoryPackageTypes/${id}`);
    return response?.data;
  };
  static inventoryPackageTypesVisibility = async (data) => {
    const response = await api.patch(`/inventoryPackageTypes/${data?.id}/visibility/${data?.checked}`);
    return response?.data;
  };
  // ---- end generated ----
  ...
  static addInventoryTechnicalDetails = async (value) => {
    const response = await api.post("/inventoryTechnicalDetails", value);
    return response?.data;
  };
  static editInventoryTechnicalDetails = async (data) => {
    const response = await api.put(`/inventoryTechnicalDetails/${data?.id}`, data);
    return response?.data;
  };
  static deleteInventoryTechnicalDetails = async (id, category) => {
    const response = await api.delete(`/inventoryTechnicalDetails/${id}/category/${category}`);
    return response?.data;
  };
  static inventoryTechnicalDetailsVisibility = async (data) => {
    const response = await api.patch(`/inventoryTechnicalDetails/${data?.id}/visibility/${data?.checked}`);
    return response?.data;
  };
  // ---- end generated ----
