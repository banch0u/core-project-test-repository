...
class Services {
  ...
  static getDefaultAgreementPlansAll = async (visibility, internalStructureId) => {
    const response = await api.get(`/defaultagreementplans?visibility=${visibility}${internalStructureId ? `&internalStructureId=${internalStructureId}` : ""}`);
    return response?.data;
  };
  ...
  static getPentions = async (size, page, query, visibility) => {
    const response = await api.get(`/pensions/${size}/page/${page}?visibility=${visibility}&name=${query?.name}`);
    return response?.data;
  };
  static getPentionsAll = async (visibility) => {
    const response = await api.get(`/pensions?visibility=${visibility}`);
    return response?.data;
  };
  static addPentions = async (value) => {
    const response = await api.post("/pensions", value);
    return response?.data;
  };
  static editPentions = async (data) => {
    const response = await api.put(`/pensions/${data?.id}`, data);
    return response?.data;
  };
  static deletePentions = async (id) => {
    const response = await api.delete(`/pensions/${id}`);
    return response?.data;
  };
  static pentionsVisibility = async (data) => {
    const response = await api.patch(`/pensions/${data?.id}/visibility/${data?.checked}`);
    return response?.data;
  };
  // ---- end generated ----
  ...
  static getProjects = async (size, page, query, visibility) => {
    const response = await api.get(`/projects/${size}/page/${page}?visibility=${visibility}&name=${query?.name}`);
    return response?.data;
  };
  static getProjectsAll = async (visibility) => {
    const response = await api.get(`/projects?visibility=${visibility}`);
    return response?.data;
  };
  static addProjects = async (value) => {
    const response = await api.post("/projects", value);
    return response?.data;
  };
  static editProjects = async (data) => {
    const response = await api.put(`/projects/${data?.id}`, data);
    return response?.data;
  };
  static deleteProjects = async (id) => {
    const response = await api.delete(`/projects/${id}`);
    return response?.data;
  };
  static projectsVisibility = async (data) => {
    const response = await api.patch(`/projects/${data?.id}/visibility/${data?.checked}`);
    return response?.data;
  };
  // ---- end generated ----
  ...
  static getCustomers = async (size, page, query, visibility) => {
    const response = await api.get(`/customers/${size}/page/${page}?visibility=${visibility}&name=${query?.name}`);
    return response?.data;
  };
  static getCustomersAll = async (visibility) => {
    const response = await api.get(`/customers?visibility=${visibility}`);
    return response?.data;
  };
  static addCustomers = async (value) => {
    const response = await api.post("/customers", value);
    return response?.data;
  };
  static editCustomers = async (data) => {
    const response = await api.put(`/customers/${data?.id}`, data);
    return response?.data;
  };
  static deleteCustomers = async (id) => {
    const response = await api.delete(`/customers/${id}`);
    return response?.data;
  };
  static customersVisibility = async (data) => {
    const response = await api.patch(`/customers/${data?.id}/visibility/${data?.checked}`);
    return response?.data;
  };
  // ---- end generated ----
  ...
  static getInventoryBrands = async (size, page, query, visibility) => {
    const response = await api.get(`/inventory/brands/${size}/page/${page}?visibility=${visibility}&name=${query?.name}`);
    return response?.data;
  };
  static getInventoryBrandsAll = async (visibility) => {
    const response = await api.get(`/inventory/brands?visibility=${visibility}`);
    return response?.data;
  };
  static addInventoryBrands = async (value) => {
    const response = await api.post("/inventory/brands", value);
    return response?.data;
  };
  static editInventoryBrands = async (data) => {
    const response = await api.put(`/inventory/brands/${data?.id}`, data);
    return response?.data;
  };
  static deleteInventoryBrands = async (id) => {
    const response = await api.delete(`/inventory/brands/${id}`);
    return response?.data;
  };
  static inventoryBrandsVisibility = async (data) => {
    const response = await api.patch(`/inventory/brands/${data?.id}/visibility/${data?.checked}`);
    return response?.data;
  };
  // ---- end generated ----
  ...
  static getInventoryCategories = async (size, page, visibility) => {
    const response = await api.get(`/inventory/categories/${size}/page/${page}?visibility=${visibility}`);
    return response?.data;
  };
  static getInventoryCategoriesAll = async (visibility) => {
    const response = await api.get(`/inventory/categories?visibility=${visibility}`);
    return response?.data;
  };
  static addInventoryCategories = async (value) => {
    const response = await api.post("/inventory/categories", value);
    return response?.data;
  };
  static editInventoryCategories = async (data) => {
    const response = await api.put(`/inventory/categories/${data?.id}`, data);
    return response?.data;
  };
  static deleteInventoryCategories = async (id) => {
    const response = await api.delete(`/inventory/categories/${id}`);
    return response?.data;
  };
  static inventoryCategoriesVisibility = async (data) => {
    const response = await api.patch(`/inventory/categories/${data?.id}/visibility/${data?.checked}`);
    return response?.data;
  };
  // ---- end generated ----
  ...
  static getInventoryModels = async (size, page, query, visibility, inventoryBrands) => {
    const response = await api.get(`/inventoryModels/${size}/page/${page}?inventoryBrandIds=${inventoryBrands}&visibility=${visibility}&name=${query?.name}`);
    return response?.data;
  };
  static getInventoryModelsAll = async (visibility, brandId) => {
    const response = await api.get(`/inventoryModels?visibility=${visibility}&inventoryBrandIds=${brandId}`);
    return response?.data;
  };
  static addInventoryModels = async (value) => {
    const response = await api.post("/inventoryModels", value);
    return response?.data;
  };
  static editInventoryModels = async (data) => {
    const response = await api.put(`/inventoryModels/${data?.id}`, data);
    return response?.data;
  };
  static deleteInventoryModels = async (id) => {
    const response = await api.delete(`/inventoryModels/${id}`);
    return response?.data;
  };
  static inventoryModelsVisibility = async (data) => {
    const response = await api.patch(`/inventoryModels/${data?.id}/visibility/${data?.checked}`);
    return response?.data;
  };
  // ---- end generated ----
  ...
  static getinventoryPackageTypes = async (size, page, query, visibility) => {
    const response = await api.get(`/inventory/packagetypes/${size}/page/${page}?visibility=${visibility}&name=${query?.name}`);
    return response?.data;
  };
  static getinventoryPackageTypesAll = async (visibility) => {
    const response = await api.get(`/inventory/packagetypes?visibility=${visibility}`);
    return response?.data;
  };
  static addinventoryPackageTypes = async (value) => {
    const response = await api.post("/inventory/packagetypes", value);
    return response?.data;
  };
  static editinventoryPackageTypes = async (data) => {
    const response = await api.put(`/inventory/packagetypes/${data?.id}`, data);
    return response?.data;
  };
  static deleteinventoryPackageTypes = async (id) => {
    const response = await api.delete(`/inventory/packagetypes/${id}`);
    return response?.data;
  };
  static inventoryPackageTypesVisibility = async (data) => {
    const response = await api.patch(`/inventory/packagetypes/${data?.id}/visibility/${data?.checked}`);
    return response?.data;
  };
  // ---- end generated ----
  ...
  static getInventoryTechnicalDetails = async (size, page, query, visibility, inventoryCategoryId) => {
    const response = await api.get(`/inventory/technicaldetails/${size}/page/${page}?visibility=${visibility}&name=${query?.name}&inventoryCategoryId=${inventoryCategoryId}`);
    return response?.data;
  };
  static getInventoryTechnicalDetailsAll = async (visibility, inventoryCategoryId) => {
    const response = await api.get(`/inventory/technicaldetails?visibility=${visibility}&inventoryCategoryId=${inventoryCategoryId}`);
    return response?.data;
  };
  static addInventoryTechnicalDetails = async (value) => {
    const response = await api.post("/inventory/technicaldetails", value);
    return response?.data;
  };
  static editInventoryTechnicalDetails = async (data) => {
    const response = await api.put(`/inventory/technicaldetails/${data?.id}`, data);
    return response?.data;
  };
  static deleteInventoryTechnicalDetails = async (id, category) => {
    const response = await api.delete(`/inventory/technicaldetails/${id}/category/${category}`);
    return response?.data;
  };
  static inventoryTechnicalDetailsVisibility = async (data) => {
    const response = await api.patch(`/inventory/technicaldetails/${data?.id}/visibility/${data?.checked}`);
    return response?.data;
  };
  // ---- end generated ----
  ...
  static getVendorCategories = async (size, page, query, visibility) => {
    const response = await api.get(`/vendor/categories/${size}/page/${page}?visibility=${visibility}`);
    return response?.data;
  };
  static getVendorCategoriesAll = async (visibility) => {
    const response = await api.get(`/vendor/categories?visibility=${visibility}`);
    return response?.data;
  };
  static addVendorCategories = async (value) => {
    const response = await api.post("/vendor/categories", value);
    return response?.data;
  };
  static editVendorCategories = async (data) => {
    const response = await api.put(`/vendor/categories/${data?.id}`, data);
    return response?.data;
  };
  static deleteVendorCategories = async (id) => {
    const response = await api.delete(`/vendor/categories/${id}`);
    return response?.data;
  };
  static vendorCategoriesVisibility = async (data) => {
    const response = await api.patch(`/vendor/categories/${data?.id}/visibility/${data?.checked}`);
    return response?.data;
  };
  // ---- end generated ----
...
// ---- generated by questionnaireGenerator: Attestations ----
  static getAttestations = async (size, page, query, visibility) => {
  ...
  static addAttestations = async (value) => {
    const response = await api.post("/attestations", value);
    return response?.data;
  };
  static editAttestations = async (data) => {
    const response = await api.put(`/attestations/${data?.id}`, data);
    return response?.data;
  };
  static deleteAttestations = async (id) => {
    const response = await api.delete(`/attestations/${id}`);
    return response?.data;
  };
  static attestationsVisibility = async (data) => {
    const response = await api.patch(`/attestations/${data?.id}/visibility/${data?.checked}`);
    return response?.data;
  };
// ---- end generated ----
