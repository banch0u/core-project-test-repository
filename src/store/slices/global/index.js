...
const initialState = {
  ...
  topicsRender: false,
  AttestationsRender: false,
  VendorCategoriesRender: false,
  InventoryTechnicalDetailsRender: false,
  inventoryPackageTypesRender: false,
  InventoryModelsRender: false,
  InventoryCategoriesRender: false,
  InventoryBrandsRender: false,
...
export const global = createSlice({
  ...
  initialState,
  reducers: {
    setAttestationsRender: (state, { payload }) => {
      state.AttestationsRender = payload;
    },

    setVendorCategoriesRender: (state, { payload }) => {
      state.VendorCategoriesRender = payload;
    },

    setInventoryTechnicalDetailsRender: (state, { payload }) => {
      state.InventoryTechnicalDetailsRender = payload;
    },

    setinventoryPackageTypesRender: (state, { payload }) => {
      state.inventoryPackageTypesRender = payload;
    },

    setInventoryModelsRender: (state, { payload }) => {
      state.InventoryModelsRender = payload;
    },

    setInventoryCategoriesRender: (state, { payload }) => {
      state.InventoryCategoriesRender = payload;
    },

    setInventoryBrandsRender: (state, { payload }) => {
      state.InventoryBrandsRender = payload;
    },
    ...
    setRouteLocationsRender: (state, { payload }) => {
      state.RouteLocationsRender = payload;
    },
    ...
    setContractTopicsRender: (state, { payload }) => {
    ...
    setRepairmentWorkTypesRender: (state, { payload }) => {
    ...
    insuranceTypesRender: (state, { payload }) => {
...
export const {
  ...
  setAttestationsRender,
  setVendorCategoriesRender,
  setInventoryTechnicalDetailsRender,
  setinventoryPackageTypesRender,
  setInventoryModelsRender,
  setInventoryCategoriesRender,
  setInventoryBrandsRender,
  setCustomersRender,
  setProjectsRender,
  setPentionsRender,
